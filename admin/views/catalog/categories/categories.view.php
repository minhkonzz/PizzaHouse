<div class="pagetitle">
   ...
   <div style="display: flex; justify-content: space-between; align-items: center;">
      ...
      <div>
         <button id="multiple-remove-btn"></button>
   ...
   <div>
      ...
      <?php 
        ...
        foreach ($categories as $category): 
          ...
          <tr class="table__row">
             <td><input type="checkbox" style="width: 15px; height: 15px; margin: 0 15px;" data-category-id="<?= $id ?>"></td>
             <td><?= $id ?></td>
             <td><?= $category_name ?></td>
             <td><?= $created_at ?></td>
...
<script src="<?= ROOT_ADMIN_CLIENT . "public/js/categories4.js" ?>"></script>