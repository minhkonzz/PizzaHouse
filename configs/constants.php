<?php 
  ...
  define("ROOT_CLIENT", $is_local_env ? "/pizza-complete-version/" : $_ENV["DOMAIN"]);
  ...
  define("ROOT_ADMIN_CLIENT", ($is_local_env ? "/pizza-complete-version" : $_ENV["DOMAIN"]) . "/admin/");
  ...
  echo "<pre>"; 
  echo "ROOT_CLIENT: " . ROOT_CLIENT;
  echo "<pre>";  
  echo "ROOT_ADMIN: " . ROOT_ADMIN;
  echo "<pre>";
  echo "ROOT_ADMIN_CLIENT: " . ROOT_ADMIN_CLIENT; 
?>